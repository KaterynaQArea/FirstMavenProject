...
public class WebsiteTest extends BaseTest {
    ...
    public void removeAllRecords() {
        ...
        yourNameField.click();
        WebElement user = webDriver.findElement(By.xpath("//option[text()='Harry Potter']"));
        user.click();
        WebElement loginButton = webDriver.findElement(By.xpath("//button[text()='Login']"));
        loginButton.click();
        WebElement depositButton = webDriver.findElement(By.xpath("//button[contains(text(),'Deposit')]"));
        depositButton.click();
        ...
        WebElement withdrawButton = webDriver.findElement(By.xpath("//button[contains(text(),'Withdrawl')]"));
        ...
        WebElement transactionButton = webDriver.findElement(By.xpath("//button[contains(text(),'Transactions')]"));
    ...
    public void openAccountTab() {
        ...
        WebElement addCustomerButton = webDriver.findElement(By.xpath("//button[contains(text(),'Add Customer')]"));
        ...
        WebElement openAccountButton = webDriver.findElement(By.xpath("//button[contains(text(),'Open Account')]"));
    ...
    public void createAccount() {
        ...
        WebElement customer = webDriver.findElement(By.xpath("//option[text()='Ron Weasly']"));
        customer.click();
        WebElement currencyField = webDriver.findElement(By.name("currency"));
        currencyField.click();
        WebElement currency = webDriver.findElement(By.xpath("//option[text()='Dollar']"));
        currency.click();
        WebElement processButton = webDriver.findElement(By.xpath("//button[text()='Process']"));
        processButton.click();
        webDriver.switchTo().alert().accept();
